...
plt.plot(p_N_vec, error_array[:, 1], label='Async: Fehlerrate nach Erreichen des Fixpunktes')
plt.plot(p_N_vec, error_array[:, 2], label='Sync: Fehlerrate am Fixpunktes')
plt.plot(p_N_vec, error_array[:, 3], label='Sync: Fehlerrate am Fixpunktes oder Oscillation')
plt.xlabel('$p / N$')
...
npzfile = np.load('../latex/images/4_2_1/spurious_states_{}_{}_data.npz'.format(N_statistic1, N_statistic2))
p_N_vec = npzfile['arr_0']
...
plt.tight_layout()
plt.savefig('../latex/images/4_2_1/spurious_states_{}_{}.pdf'.format(N_statistic1, N_statistic2))

# Aufgabe 4.2.2
N_statistic1, N_statistic2 = 100, 100
npzfile = np.load('../latex/images/4_2_2/spurious_states_finite_temperature_{}_{}_data.npz'.format(N_statistic1, N_statistic2))
p_N_vec = npzfile['arr_0']
P_spurious_states = npzfile['arr_1']
...
plt.legend()
plt.tight_layout()
plt.savefig('../latex/images/4_2_2/spurious_states_finite_temperature_{}_{}.pdf'.format(N_statistic1, N_statistic2))
...
plt.tight_layout()
plt.savefig('../latex/images/sigmoid_finite_temperatures.pdf'.format(N_statistic1, N_statistic2))
