...
for i, p in enumerate(p_vec):
    ...
    for j in range(N_statistic):
        ...
        for k in range(p):
            ...
            hopfield_network.set_initial_neurons_state(np.copy(hopfield_network.xi[:, k]))
...
np.savez('../latex/images/4_1/fehlerrate_{}_data'.format(N_statistic), p_N_vec, error_array, t_steps_vec_max_iter)
