...
N = 100 ** 2
path_list = [os.path.join(DATA_DIR, 'images/famous_physicists', f) for f in ['einstein.jpg', 'hilbert.jpg', 'curie.jpg', 'de_broglie.jpg', 'dirac.jpg', 'feynman.jpg', 'heisenberg.jpg', 'humboldt.jpg', 'newton.jpg', 'schroedinger.jpg']]
...
plot_network_development(hopfield_network, 3, 'async', einstein, '../latex/images/reconstruct_einstein.pdf')
...
# Plotte Neuronenkonfiguartion fuer 3 Zeitschritte
plot_network_development(hopfield_network, 3, 'async', hilbert, '../latex/images/reconstruct_hilbert.pdf')
...
plot_network_development(hopfield_network, 6, 'sync', pattern1, '../latex/images/sync_oscillation.pdf', anno_hamming=False)
