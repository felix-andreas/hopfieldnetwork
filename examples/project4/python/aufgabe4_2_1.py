...
for i, p in enumerate(p_vec):
    for j in range(N_statistic1):
        ...
        for j2 in range(N_statistic2):
            hopfield_network.set_initial_neurons_state(2 * np.random.randint(2, size=N) - 1)
...
np.savez('../latex/images/4_2_1/spurious_states_{}_{}_data'.format(N_statistic1, N_statistic2), p_N_vec, P_spurious_states)
